...
public class _2_DragonAccounting {
    ...
    public static void main(String[] args) {
        ...
        while(!(command=scanner.nextLine()).equals("END")){
         String[] tokens=command.trim().split(";");
            ...
            hiredWorkers(hiredWorkers,monthlySalary);
            raiseSalaries();
            paySalaries(); // pay
    ...
    private static void hiredWorkers(Long hireWorkers,BigDecimal salary){
        workerNumber.add(hireWorkers);
        salaries.add(salary);
    }
